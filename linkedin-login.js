...
class LinkedInAutomation {
  ...
  async submitLogin() {
    ...
    await this.page.screenshot({
      path: "screenshots/linkedin-before-login.png",
      fullPage: true,
    });
  ...
  async login(email, password) {
    try {
      ...
      if (success) {
        await this.takeScreenshot("linkedin-after-login.png");
        const title = await this.page.title();
        console.log("🔍 Title:", title);
      } else {
        await this.takeScreenshot("linkedin-login-failed.png");
      }
...
async function main() {
  ...
  console.log("🤖 Using smart automation to avoid detection");
